...
public class Insertion {
    ...
    public void setInsertionist_id(long insertionist_id) { this.insertionist_id = insertionist_id; }
    ...
    public long getInsertionist_id() { return insertionist_id; }
