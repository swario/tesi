...
public class asincGoogleCalendar extends AsyncTask<String, Void, Event> {
    private com.google.api.services.calendar.Calendar mService = null;
    private Exception mLastError = null;

    public asincGoogleCalendar(GoogleAccountCredential credential) {
